	...
	<body id="body">
		...
		<div id="corpo" style="font-size:20px;">
			<div id="spazio"><br/><br/>
				...
				<h3> Statistiche bevande più vendute </h3>
			</div><br/><br/>
			...
			<?php
				if(isset($_POST['submit']) && $_POST['submit']==TRUE){	
					...
					$query = "select b.nome, sum(cb.quantita) from ordine as o, contiene_b as cb, bevande as b where ";
					$query .= "o.id_ordine = cb.id_ordine and cb.id_bevande = b.id_bevande ";
