	...
	<body id="body">
		...
		<div id="corpo">
			<div id="spazio"><br/><br/>
				...
				<form method="post" action="../php/statistiche/inserisci_ingrediente.php" name="pizza">
						<h2>Inserimento nuovo ingrediente per pizza/pizzolo</h2>
						<br/><br/>
						Nome: <br/><input type="text" size="20" name="nome" required>
						<br/><br/>Prezzo: <br/><input type="text" size="20" name="prezzo" required><br/><br/>
						<input type="submit" value="Inserisci ingrediente"/>
				</form>
			<br/><br/>
